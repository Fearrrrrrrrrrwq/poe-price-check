...
STRINGS["en"] = {
    ...
    "res.craft_ceiling": "Price ceiling for this base",
    "res.wider": "Wider -10%",
    "res.any_base": "Ignore base",
    "res.any_base_hint": "price these mods on any base",
    "res.any_base_hint_unique": "find this unique on any base variant",
    "res.all": "All",
    "res.none": "None",
    ...
    "prop.ar": "Armour",
    "prop.ev": "Evasion",
    "prop.es": "Energy Shield",
    "prop.ward": "Ward",
    "prop.block": "Block chance",
    "prop.map_iiq": "Item Quantity",
...
STRINGS["pl"] = {
    ...
    "res.craft_ceiling": "Sufit ceny tej bazy",
    "res.wider": "Szeroki -10%",
    "res.any_base": "Ignoruj bazę",
    "res.any_base_hint": "wyceń te mody na dowolnej bazie",
    "res.any_base_hint_unique": "szukaj tego unikatu niezależnie od bazy",
    "res.all": "Wszystkie",
    "res.none": "Żadne",
    ...
    "prop.ar": "Pancerz",
    "prop.ev": "Unik",
    "prop.es": "Tarcza energii",
    "prop.ward": "Osłona (Ward)",
    "prop.block": "Szansa na blok",
    "prop.map_iiq": "Ilość przedmiotów",
...
STRINGS["de"] = {
    ...
    "res.craft_ceiling": "Preisobergrenze dieser Basis",
    "res.wider": "Weiter -10%",
    "res.any_base": "Basis ignorieren",
    "res.any_base_hint": "diese Mods auf beliebiger Basis bewerten",
    "res.any_base_hint_unique": "dieses Unique auf jeder Basisvariante suchen",
    "res.all": "Alle",
    "res.none": "Keine",
    ...
    "prop.ar": "Rüstung",
    "prop.ev": "Ausweichen",
    "prop.es": "Energieschild",
    "prop.ward": "Ward",
    "prop.block": "Blockchance",
    "prop.map_iiq": "Gegenstandsmenge",
...
STRINGS["es"] = {
    ...
    "res.craft_ceiling": "Techo de precio de esta base",
    "res.wider": "Amplio -10%",
    "res.any_base": "Ignorar base",
    "res.any_base_hint": "tasar estos mods en cualquier base",
    "res.any_base_hint_unique": "buscar este único en cualquier base",
    "res.all": "Todos",
    "res.none": "Ninguno",
    ...
    "prop.ar": "Armadura",
    "prop.ev": "Evasión",
    "prop.es": "Escudo de energía",
    "prop.ward": "Ward",
    "prop.block": "Probabilidad de bloqueo",
    "prop.map_iiq": "Cantidad de objetos",
...
STRINGS["pt"] = {
    ...
    "res.craft_ceiling": "Teto de preço desta base",
    "res.wider": "Amplo -10%",
    "res.any_base": "Ignorar base",
    "res.any_base_hint": "avaliar estes mods em qualquer base",
    "res.any_base_hint_unique": "procurar este único em qualquer base",
    "res.all": "Todos",
    "res.none": "Nenhum",
    ...
    "prop.ar": "Armadura",
    "prop.ev": "Evasão",
    "prop.es": "Escudo de energia",
    "prop.ward": "Ward",
    "prop.block": "Chance de bloqueio",
    "prop.map_iiq": "Quantidade de itens",
...
STRINGS["ru"] = {
    ...
    "res.craft_ceiling": "Потолок цены этой базы",
    "res.wider": "Шире -10%",
    "res.any_base": "Игнорировать базу",
    "res.any_base_hint": "оценить эти моды на любой базе",
    "res.any_base_hint_unique": "искать этот уник на любой базе",
    "res.all": "Все",
    "res.none": "Никакие",
    ...
    "prop.ev": "Уклонение",
    "prop.es": "Энергощит",
    "prop.ward": "Оберег (Ward)",
    "prop.block": "Шанс блока",
    "prop.map_iiq": "Количество предметов",
